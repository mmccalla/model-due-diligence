...
from model_due_diligence.domain.models import ReportFormat, RiskLevel, ScanContext
...
def parse_report_formats(value: str) -> tuple[ReportFormat, ...]:
    ...
    for item in requested:
        try:
            ...
            valid = ", ".join(report_format.value for report_format in ReportFormat)
...
def write_reports(context: ScanContext, report: object) -> list[Path]:
